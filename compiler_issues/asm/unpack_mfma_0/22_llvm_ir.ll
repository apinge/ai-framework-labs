...
define amdgpu_kernel void @unpack_mfma_0(ptr addrspace(1) %0, ptr addrspace(1) %1, ptr addrspace(1) %2) #0 !dbg !3 !reqd_work_group_size !6 {
  ...
  %11 = call <2 x float> asm "v_cvt_pk_f32_fp8 $0, $1", "=v,v"(i32 %10), !dbg !12
  %12 = call <2 x float> asm "v_cvt_pk_f32_fp8_sdwa $0, $1 src0_sel:WORD_1", "=v,v"(i32 %10), !dbg !13
  ...
  %28 = call <2 x float> asm "v_cvt_pk_f32_fp8 $0, $1", "=v,v"(i32 %27), !dbg !12
  %29 = call <2 x float> asm "v_cvt_pk_f32_fp8_sdwa $0, $1 src0_sel:WORD_1", "=v,v"(i32 %27), !dbg !13
  ...
  %45 = call <2 x float> asm "v_cvt_pk_f32_fp8 $0, $1", "=v,v"(i32 %44), !dbg !12
  %46 = call <2 x float> asm "v_cvt_pk_f32_fp8_sdwa $0, $1 src0_sel:WORD_1", "=v,v"(i32 %44), !dbg !13
  ...
  %62 = call <2 x float> asm "v_cvt_pk_f32_fp8 $0, $1", "=v,v"(i32 %61), !dbg !12
  %63 = call <2 x float> asm "v_cvt_pk_f32_fp8_sdwa $0, $1 src0_sel:WORD_1", "=v,v"(i32 %61), !dbg !13
...
declare <4 x float> @llvm.amdgcn.mfma.f32.16x16x16bf16.1k(<4 x i16>, <4 x i16>, <4 x float>, i32 immarg, i32 immarg, i32 immarg) #2

attributes #0 = { "amdgpu-flat-work-group-size"="64,64" "uniform-work-group-size" }
attributes #1 = { nocallback nofree nosync nounwind speculatable willreturn memory(none) }
attributes #2 = { convergent nocallback nocreateundeforpoison nofree nosync nounwind willreturn memory(none) }
...
!11 = !DILocation(line: 34, column: 21, scope: !3)
!12 = !DILocation(line: 31, column: 12, scope: !3)
!13 = !DILocation(line: 40, column: 12, scope: !3)
