...
.Lfunc_begin0:
	...
	.loc	1 31 12
	;;#ASMSTART
	v_cvt_pk_f32_fp8 v[14:15], v5
	;;#ASMEND
	.loc	1 52 23
	s_nop 0
	v_perm_b32 v9, v9, v8, s0
	v_perm_b32 v8, v7, v6, s0
	.loc	1 31 12
	;;#ASMSTART
	v_cvt_pk_f32_fp8 v[6:7], v4
	;;#ASMEND
	.loc	1 52 23
	v_perm_b32 v13, v13, v12, s0
	v_perm_b32 v12, v7, v6, s0
	v_perm_b32 v3, v3, v2, s0
	v_perm_b32 v2, v11, v10, s0
	.loc	1 64 16
	s_waitcnt vmcnt(0)
	v_mfma_f32_16x16x16_bf16 v[6:9], v[8:9], v[16:17], 0
	.loc	1 40 12
	;;#ASMSTART
	v_cvt_pk_f32_fp8_sdwa v[4:5], v5 src0_sel:WORD_1
	;;#ASMEND
	.loc	1 64 16
	v_mfma_f32_16x16x16_bf16 v[10:13], v[12:13], v[16:17], 0
	.loc	1 52 23
	v_perm_b32 v17, v5, v4, s0
	v_perm_b32 v16, v15, v14, s0
	.loc	1 64 16
	v_mfma_f32_16x16x16_bf16 v[2:5], v[2:3], v[18:19], v[6:9]
	s_nop 0
	v_mfma_f32_16x16x16_bf16 v[6:9], v[16:17], v[18:19], v[10:13]
	.loc	1 77 8
	s_nop 4
...
.Lfunc_end0:
	...
	.set .Lunpack_mfma_0.num_vgpr, 20
